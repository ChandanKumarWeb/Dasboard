            ...
            <tbody>
              {products.map((product) => (
                ...
                >
                  ...
                  <td className="py-3 px-6">{product.lname}</td>
                  <td className="py-3 px-6 text-center">{product.email}</td>
                  <td className="py-3 px-6 text-center">{product.phone}</td>
                  <td className="py-3 px-6 text-center">{product.gender}</td>
                  <td className="py-3 px-6 text-center">{product.address}</td>
